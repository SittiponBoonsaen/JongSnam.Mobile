...
namespace JongSnam.Mobile.Services.Base
{
    public abstract class BaseServices
    {
        ...
        public BaseServices()
        {
            ...
            //JongSnamServices = new JongSnamServices(new Uri("http://192.168.224.1:5545/"), handler);
            JongSnamServices = new JongSnamServices(new Uri("http://192.168.39.225:8080/"), handler);
        }
