...
namespace JongSnamServices.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the UpdateStoreRequest class.
        /// </summary>
        ...
        /// Initializes a new instance of the UpdateStoreRequest class.
        /// </summary>
        public UpdateStoreRequest(string name, string address, int subDistrict, int district, int province, string contactMobile, bool isOpen, string image = default(string), double? latitude = default(double?), double? longtitude = default(double?), string officeHours = default(string), string rules = default(string))
        {
            Image = image;
            Name = name;
            Address = address;
